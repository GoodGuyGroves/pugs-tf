...
import aiofiles
from miss_pauling.fastdl.core.config import settings
from miss_pauling.fastdl.core.mapcycle import mapcycle_manager
from miss_pauling.fastdl.core.auth import get_current_user, require_auth, require_helper_or_above, AuthenticatedUser
from miss_pauling.fastdl.core.tf2_versions import tf2_sort_key
...
_fastdl_dir = Path(__file__).resolve().parent
templates = Jinja2Templates(directory=str(_fastdl_dir / "templates"))
app.mount("/static", StaticFiles(directory=str(_fastdl_dir / "static")), name="static")
