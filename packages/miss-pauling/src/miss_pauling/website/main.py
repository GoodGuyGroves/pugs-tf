...
from miss_pauling.website.models.responses import HomePageContext
...
_pkg_dir = Path(__file__).resolve().parent.parent  # miss_pauling/
templates = Jinja2Templates(directory=str(_pkg_dir / "templates"))
app.mount("/static", StaticFiles(directory=str(_pkg_dir / "static")), name="static")

# Add mkdocs to /docs
docs_path = Path(__file__).resolve().parent.parent.parent.parent.parent.parent / "docs" / "site"
