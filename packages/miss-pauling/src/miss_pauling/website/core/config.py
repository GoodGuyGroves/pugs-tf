...
# Resolve settings.json path relative to the miss_pauling package root
_PACKAGE_DIR = Path(__file__).resolve().parent.parent.parent  # miss_pauling/
_SETTINGS_JSON = str(_PACKAGE_DIR / "website_settings.json")
