...
from miss_pauling.shared.database import get_database_url, Base
from miss_pauling.shared.models import User, UserSession, Role, UserRole, RoleType  # Import all models here for Alembic to detect
